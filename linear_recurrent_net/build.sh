...
mkdir lib
nvcc -c linear_recurrence_base.cu -o lib/linear_recurrence_base.o -O3 --compiler-options '-fPIC'
nvcc -c linear_recurrence_fast.cu -o lib/linear_recurrence_fast.o -O3 --compiler-options '-fPIC'
nvcc lib/linear_recurrence_base.o lib/linear_recurrence_fast.o -shared -o lib/liblinear_recurrence.so --compiler-options '-fPIC'
